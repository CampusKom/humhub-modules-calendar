...
class CalendarEntryForm extends Model
{
    ...
    */
    ...
    public function createNew($contentContainer, $start = null, $end = null,$recur_end)
    {
        ...
        $this->translateDateTimes($start, $end, $recur_end, $this->timeZone, $this->timeZone);
    }
    ...
    public function updateTime($start = null, $end = null, $recur_end )
    {
        $this->entry->time_zone = Yii::$app->formatter->timeZone;
        $this->translateDateTimes($start, $end,$recur_end, null, null, 'php:Y-m-d H:i:s');
        return $this->save();
    }
